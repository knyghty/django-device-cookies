...
DEVICE_COOKIE_PERIOD = getattr(settings, "DEVICE_COOKIES_PERIOD", datetime.timedelta(hours=1))

DEVICE_COOKIE_REQUESTS_PER_PERIOD = getattr(settings, "DEVICE_COOKIES_REQUESTS_PER_PERIOD", 3)
